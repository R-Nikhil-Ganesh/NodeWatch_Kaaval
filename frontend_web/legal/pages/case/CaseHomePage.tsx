      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <Card title="Case Details">
            <dl>
              <DescriptionRow label="FIR Number" value={courtCase.firNumber ? `${courtCase.firNumber} (${formatDate(courtCase.firDate)})` : '—'} />
              <DescriptionRow label="Police Station" value={courtCase.policeStation} />
              <DescriptionRow label="District / State" value={(courtCase.district || courtCase.state) ? `${courtCase.district || '—'}, ${courtCase.state || '—'}` : '—'} />
              ...
              <DescriptionRow label="Investigating Officer" value={courtCase.investigatingOfficer ? `${courtCase.investigatingOfficer} — ${courtCase.investigatingOfficerDesignation || '—'}` : '—'} />
