...
interface AuthProviderProps {
  children: ReactNode;
  /** Notifies the host shell (the unified web app) that this session ended,
   *  so it can drop back to its own login screen — this embedded copy of the
   *  Legal app has no /login route of its own to redirect to. */
  onLogout?: () => void;
}
