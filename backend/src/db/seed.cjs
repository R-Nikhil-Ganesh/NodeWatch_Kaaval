...
const USERS = [
  ...
  { user_id: 'u_forensics_2', username: 'forensic2', email: 'lakshmi.raman@tnfsl.gov.in', password: 'password123', name: 'Lakshmi Raman', role: 'FORENSICS', designation: 'Scientific Assistant', org_msp: 'Org2MSP' },
  {
    ...
    name: 'Vijay Sundaram', role: 'LEGAL', designation: 'Public Prosecutor', org_msp: 'Org2MSP',
  ...
  { user_id: 'u_legal_2', username: 'legal2', email: 'meena.krishnan@tnhc.gov.in', password: 'password123', name: 'Meena Krishnan', role: 'LEGAL', designation: 'District Judge', org_msp: 'Org2MSP' },
  {
    user_id: 'u_legal_3', username: 'legal3', email: 'kalaiselvi.r@tnjudiciary.gov.in', password: 'password123',
    name: 'Justice R. Kalaiselvi', role: 'LEGAL', designation: 'District Judge', org_msp: 'Org2MSP',
  ...
  },
  {
    ...
    name: 'Aishwarya Menon', role: 'LEGAL', designation: 'Defense Counsel', org_msp: 'Org2MSP',
  ...
  },
  {
    ...
    name: 'Ganesh Prabhakaran', role: 'LEGAL', designation: 'Registrar', org_msp: 'Org2MSP',
